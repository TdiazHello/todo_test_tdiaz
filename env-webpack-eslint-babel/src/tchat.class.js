...
const Tchat = class {
  ...
  renderTypingMessage() {
    return `
      <div class="input-group mb-3 typing-message">
  ...
  sendMessage(elInput) {
    const newElInput = elInput;
    const elMessages = document.querySelector('.messages');
    const keyword = newElInput.value;
  ...
  onClickSendMessage() {
    ...
    const elBtn = document.querySelector('.typing-message button');

    elBtn.addEventListener('click', () => {
      this.sendMessage(elInput);
    });
